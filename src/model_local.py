...
if __name__ == "__main__":
        ...
        df = pd.read_csv(filepath_or_buffer='./data/data.csv', delimiter=';')
    ...
    #df = Dataset.File.from_files(path=(datastore, 'datasets/muestradatos'))
        ...
        print("\n")
        print("clases:",predicted_clases)

        #caracteristicas seleccionadas
        print("\n")
        print("caracteristicas seleccionadas",sfs1.k_feature_names_)

        #Predictions
        predictions=clfKnn_sfs.predict(X_test_sfs)

        #Valor F
        print("score:", f1_score(y_test,predictions.astype('int64'), average='weighted'))
